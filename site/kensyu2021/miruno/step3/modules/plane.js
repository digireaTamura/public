...
class Ita extends THREE.Object3D {
    ...
    create = async() => {
        ...
        const texture = await loader.load("./step3/miruno.jpg");
        ...
        const res_frag2 = await fetch("./step3/modules/ita2.frag");
        const frag2 = await res_frag2.text();
    
        const res_vert2 = await fetch("./step3/modules/ita2.vert");
